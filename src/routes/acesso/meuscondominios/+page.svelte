...
<h2 class="my-4 font-bold text-2xl">MEUS CONDOMINIOS</h2>
	...
	<div class="bg-white rounded-xl shadow-md overflow-hidden">
		...
		<div class="p-4">
			...
			<p class="text-gray-500 text-sm">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor, mi sed egestas
				tincidunt, libero dolor bibendum nisl, non aliquam quam massa id lacus.
			</p>
		</div>
	</div>
