<script lang="ts">
	import type { PageData } from '../../meuscondominios/[condominio]/$types';
	...
	<div class="flex flex-col">
		...
		>
			...
			<p class="w-fit text-gray-700 dark:text-gray-400 text-md">
				...
				eveniet. Odit, consequatur. Ratione voluptate exercitationem hic eligendi vitae animi nam
				in, est earum culpa illum aliquam.
			</p>
